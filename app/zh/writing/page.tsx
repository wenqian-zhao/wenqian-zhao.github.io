...
export const metadata: Metadata = { title: "文章 — 赵文千", description: "关于 AI、品味、工作和生活，还有一些暂时没想明白的事。", openGraph: { title: "文章 — 赵文千", description: "一些还没想完的事。", images: [] }, twitter: { card: "summary", title: "文章 — 赵文千", description: "一些还没想完的事。", images: [] } };
